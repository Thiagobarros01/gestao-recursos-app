<section class="page-head">
    ...
    <p>Cadastros base, departamentos e acessos de usuarios.</p>
</section>
...
<section class="card-grid">
    <article class="card">
        <h2>Departamentos</h2>
        <form method="post" action="index.php?r=ti.settings.departments.store" class="inline-form">
            <input type="text" name="name" placeholder="Ex: Financeiro" required>
            <button type="submit">Adicionar</button>
        </form>
        <?php if ($editingDepartment): ?>
            <form method="post" action="index.php?r=ti.settings.departments.update" class="inline-form">
        ...
        <ul class="simple-list stack-list">
            <?php foreach ($departments as $department): ?>
                <li class="stack-item">
                    ...
                    <div class="actions-inline">
                        <a class="btn btn-muted" href="index.php?r=ti.settings&department_edit=<?= (int) $department['id'] ?>">Editar</a>
                        <form method="post" action="index.php?r=ti.settings.departments.delete" onsubmit="return confirm('Deseja excluir este departamento?');">
    ...
    <article class="card">
        ...
        <form method="post" action="index.php?r=<?= $editingUser ? 'ti.settings.users.update' : 'ti.settings.users.store' ?>" class="form-grid two">
            <?php if ($editingUser): ?>
